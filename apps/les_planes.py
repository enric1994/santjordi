...
def message():
    ...
    tasks=("Avui al jove Marc li toca fer la cuina. Eric vas baixar les bosses ahir?","Avui al David li toca fer la cuina","Avui la cuina la farà l'Enric","Avui la cuina li toca a l'Uri","Avui l'Eric hauria de treure la rentaplats i posar tot el que estigui fora","Avui estaria bé rifar qui posa la rentaplats","Avui el jove Eric te la missió de baixar 3 bosses de basura")
